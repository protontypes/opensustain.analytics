...
def render_organisations_tab(df_organisations):
    ...
    df_clean, df_countries_count, df_continent_counts, df_projects_country = process_organisations_data(
        df_organisations)
    ...
    with st.container(border=True):
        ...
        st.plotly_chart(fig_top_org_listed_proj, width='stretch')
    ...
    with st.container(border=True):
        ...
        st.plotly_chart(fig_orgs_by_type, width='stretch')
    ...
    with st.container(border=True):
        ...
        st.plotly_chart(fig_top_org_countries, width='stretch')
